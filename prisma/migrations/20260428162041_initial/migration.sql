...
-- AddForeignKey
ALTER TABLE "Match" ADD CONSTRAINT "Match_winnerUserId_fkey" FOREIGN KEY ("winnerUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Match" ADD CONSTRAINT "Match_loserUserId_fkey" FOREIGN KEY ("loserUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
