...
export function PageShell({ action, children, className, description, eyebrow, title }: PageShellProps) {
  return (
...
export function EmptyState({
  ...
  return (
    ...
    >
      ...
      {children ? <div className="max-w-xl leading-6 text-muted-foreground">{children}</div> : null}
